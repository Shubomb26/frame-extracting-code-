...
dire='C:\\Users\\singh\\OneDrive\\Desktop\\tencent'
...
for ind,vedio in enumerate(vedios):
    try:
        ...
        fe.get_n_images(every_x_frame=5)
        fe.extract_frames(every_x_frame=15, img_name=str(ind)+'tencent_',dest_path=dire+'/'+'frames')
